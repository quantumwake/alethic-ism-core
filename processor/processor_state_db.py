...
from processor.processor_state import State, StateDataKeyDefinition, StateConfigLM, StateConfigDB, StateConfig, \
    StateDataColumnDefinition, StateDataRowColumnData, StateDataColumnIndex
    ...
    def insert_state_config(self, state: State):
        ...
        if isinstance(state.config, StateConfigLM):
            ...
            def convert_template(template_path: str, template_type: str):
                if template_path:
                    template = general_utils.load_template(template_file=template_path)
    ...
    def load_state_database(self, state_id: str):
        ...
        if 'StateConfig' == state_type:
            config = StateConfig(
                ...
                storage_class=state_dict['storage_class'],
            ...
            user_template_path = config_attributes['user_template_path']
            system_template_path = config_attributes['system_template_path']
...
if __name__ == '__main__':
    ...
    # animal states load into database
    instruction_query_template_states = State.load_state('../states/animallm/prod/version0_7/p0_eval/230d7ae5b60054d124a1105b9a76bdf0783efb790c2150a5bcad55a012709295.pickle')
    db_storage.save_state_database(state=instruction_query_template_states)
